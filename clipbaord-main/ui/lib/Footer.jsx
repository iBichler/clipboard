...
export const Footer = () => (
  ...
  >
    <Stack>
      <Divider my="5" borderColor={useColorModeValue('deeporange.400', 'deeporange.400')} />
      <Stack direction="row" spacing="2" align="center" justify="space-between">
        <ButtonGroup variant="ghost" color="deeporange.600">
          <IconButton
            as="a"
            target="_blank"
            href="https://github.com/iBichler/clipboard"
            aria-label="GitHub"
